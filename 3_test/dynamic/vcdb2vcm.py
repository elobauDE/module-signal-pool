...
PROJECT_NAME='module-signal-pool'
...
class DefaultMode:
    ...
    def __init__(self):
        ...
        self.compiler_cfg='BUILTIN_MINGW_63_C'
...
VCSHELL_DB_NAME='module-signal-pool.db'
